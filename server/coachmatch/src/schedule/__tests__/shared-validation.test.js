...
describe('schedule/shared/validation › validateDateTimeRange', () => {
  ...
  // Data sem hora e espaço no lugar do `T` eram aceitos pelo
  // `datetime.fromisoformat` das lambdas Python originais, mas
  // `formatScheduleDateTime` não os lê — se passassem, quebrariam na
  // notificação, depois da escrita já ter sido commitada.
  it.each(['2026-05-25', '2026-05-25 07:00:00', '2026-05-25T07', '2026-13-01T07:00:00', '25/05/2026', ''])(
    'rejeita %s',
    (value) => {
