...
// Data + `T` + hora e minuto são obrigatórios; segundos e offset, opcionais.
// Joi não cobre esse meio-termo (seu `.isoDate()` exige offset completo), por
// isso o formato continua validado à mão aqui.
//
// O `T` e o `HH:MM` não são preciosismo: o que passa por aqui é gravado e mais
// tarde formatado para as notificações, e o formatador lê os componentes de
// wall-clock direto da string. Aceitar `2026-05-25` ou `2026-05-25 07:00`
// deixaria a escrita passar e só quebraria na notificação, depois do commit.
